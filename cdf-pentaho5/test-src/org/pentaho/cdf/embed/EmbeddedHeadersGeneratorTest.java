...
public class EmbeddedHeadersGeneratorTest extends TestCase {
  ...
  public void testGenerateEmbeddedHeaders() throws IOException {
    String expected = "/** This file is generated in cdf to allow using cdf embedded.\n"
        ...
        + "src='httpTESTPROTOCOL:TEST_FULL_QUALIFIED_URL/content/pentaho-cdf/js-modules/cdf-require-js-cfg"
        + ".js'></script>\");\n"
        + "document.write(\"<script language='javascript' type='text/javascript' "
        + "src='httpTESTPROTOCOL:TEST_FULL_QUALIFIED_URL/content/pentaho-cdf/js-modules/lib/cdf-lib-require-js-cfg"
        + ".js'></script>\");\n"
        + "document.write(\"<script language='javascript' type='text/javascript' "
